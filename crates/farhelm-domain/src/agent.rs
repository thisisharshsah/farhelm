...
//!
//! Farhelm started around Claude Code, which has a hook system: it calls out
...
//! there, which is exactly what would have happened without Farhelm.
//!
...
/// session, which is what would have happened without Farhelm anyway. A
