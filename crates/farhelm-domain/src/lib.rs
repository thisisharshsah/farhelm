...
//!
//! That is enforced by what this crate depends on: `farhelm-proto` for the shapes,
...
//!
//! The types live in `farhelm-proto`, because four client implementations agree on
