...
use farhelm_proto::types::{PlanStep, PlanStepStatus, Tier};
...
/// The glance shape lives in `farhelm-proto` — the clients render it — along with
...
pub use farhelm_proto::views::PlanProgress;
