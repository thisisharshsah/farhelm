...
//! and runs an authorization code flow with PKCE. See [`farhelm_mcp::oauth`] for
//! the discovery chain.
//!
...
fn specs() -> Vec<protocol::ToolSpec> {
    vec![
        protocol::ToolSpec {
            name: "list_machines",
            description: "List the machines in this Farhelm workspace, with whether each is online, \
        ...
        protocol::ToolSpec {
            name: "start_task",
            description: "Point Farhelm's own coding agent at a repository on one of the user's \
