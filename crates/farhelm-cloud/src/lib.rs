...
//! anyone's code, which is the property `farhelm-crypto` exists to protect and the
//! reason it was worth building auth this way rather than terminating the
//! encryption at a server.
//!
//! ```text
//!   farhelm-runner ──enrol/heartbeat──▶ farhelm-cloud ◀──sign in──── web / mobile
//!        │                          (accounts, plans,                 │
//!        │                           runner registry)                 │
//!        │                                 │                          │
