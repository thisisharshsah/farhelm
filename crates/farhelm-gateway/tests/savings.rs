...
use farhelm_domain::price::{QuoteContext, quote};
use farhelm_gateway::prompt::{StableContext, Turn, approx_tokens, assemble};
use farhelm_gateway::{CompleteRequest, Gateway, GatewayConfig, StubClient};
...
async fn replay() -> Replay {
    ...
    for turn in 0..TURNS {
        ...
        let baseline_price = farhelm_domain::price::price_of(BASELINE_MODEL).unwrap();
