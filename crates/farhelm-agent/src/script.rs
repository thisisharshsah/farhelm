...
//! deterministic. It follows [`farhelm_gateway::StubClient`], which is public for
//! the same reason.
//!
//! It does not simulate prompt caching; [`farhelm_gateway::StubClient`] already
//! does that, and the numbers that matter are asserted there.

use std::sync::{Arc, Mutex};

use farhelm_gateway::ToolCall;
use farhelm_gateway::dispatch::{DispatchError, ModelClient, ModelRequest, ModelResponse, Refusal};
use farhelm_proto::types::Usage;
...
mod tests {
    use super::*;
    use farhelm_domain::price::price_of;
    use farhelm_gateway::prompt::{StableContext, assemble};
