//! What Farhelm *does*, and what it needs from the world to do it.
//!
...
//!
//! ```text
//!   farhelm-proto   shapes, no rules            (leaf: serde only)
//!        ▲
//!   farhelm-domain  rules, no I/O               (cannot read a clock)
//!        ▲
//!   farhelm-app     use cases + ports           ← you are here
//!        ▲
//!   farhelm-sqlite  one implementation of the ports
//! ```
//!
...
//! queue takes it on `flush` and `collect`, `farhelm_domain::price` prices at a
