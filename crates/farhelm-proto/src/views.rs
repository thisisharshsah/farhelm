...
//!
//! They used to live in `farhelm-runner/src/api.rs`, beside the axum handlers, and
...
impl PlanProgress {
    ...
    /// is a rule and lives in `farhelm-domain`.
